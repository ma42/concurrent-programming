...
public class WashingProgram2 extends ActorThread<WashingMessage> {
    ...
    public void run() {
        try {
            ...
            // Heat water to 40 degrees for pre-wash
            ...
            receive();
            // Start pre-wash and spin for 20 simulated minutes (one minute == 60000 milliseconds)
            Thread.sleep(20 * 60000 / Settings.SPEEDUP);
            // Stop spinning and drain water
            ...
            // Fill and heat water to 60 degrees for main wash
            water.send(new WashingMessage(this, WashingMessage.WATER_FILL, 10));
            receive();
            ...
            spin.send(new WashingMessage(this, WashingMessage.SPIN_SLOW));
            receive();
            // Start main wash and spin for 30 simulated minutes (one minute == 60000 milliseconds)
